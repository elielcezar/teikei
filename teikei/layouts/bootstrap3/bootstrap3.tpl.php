...
<div class="bootstrap clear-block panel-display" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="row">
    <?php if ($content['left']): ?>
    <div class="panel-col-first col-sm-4 col-md-4 col-lg-4">
    ...
    <div class="panel-col-center col-sm-4 col-md-4 col-lg-4">
      <div class="inside"><?php print $content['center']; ?></div>
    </div>
     <?php endif; ?>

     <?php if ($content['right']): ?>
    <div class="panel-col-last col-sm-4 col-md-4 col-lg-4">
